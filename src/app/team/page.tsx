...
const teamMembers = [
  {
    ...
    bio: 'Founder of ZEPNEX, leading the vision to build the future of shopping for modern India.',
  },
  {
    name: 'Ronak Singh',
    role: 'Co-Founder',
    image: '/team/ronak-singh.jpg',
    bio: 'Co-Founder of ZEPNEX, driving strategy, growth, and brand partnerships across the marketplace.',
  },
  {
    name: 'Vedang Soni',
    role: 'CTO & Logistics Head',
    image: '/team/vedang-soni.jpg',
    bio: 'CTO and Logistics Head of ZEPNEX, building the technology and delivery backbone of the platform.',
  },
  {
    name: 'Nisha Sethi',
